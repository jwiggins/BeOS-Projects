/*
	Segaddon.cpp - Segfault NewsTicker add-on
...
extern "C" 
{
	...
	_EXPORT TickerAddonInfo Info = { "segfault.org", "/stories.txt", "Segfault", (bigtime_t)60*60*1000*1000 /* 60 minutes. No more, no less */ };
}
