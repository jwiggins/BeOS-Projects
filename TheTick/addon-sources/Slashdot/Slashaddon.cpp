/*
	Slashaddon.cpp - Slashdot NewsTicker add-on
...
extern "C" 
{
	...
	_EXPORT TickerAddonInfo Info = { "slashdot.org", "/ultramode.txt", "Slashdot", (bigtime_t)30*60*1000*1000 /* 30 minutes. Otherwise Rob gets angry :) */ };
}
...
void parse(const char *buffer, int32 bufferlen, char ***output, char ***outlinks, int32 *outnum)
{
	...
	num_strings-=1; // slash has an extra %%\n at the end that throws my counter loop off
